using LiteDB;
using WebShop.Application.Repositories.Implementations;

namespace WebShop.Application.Tests.RepositoryTests;
...
public class BaseRepositoryTests
{
    ...
    public async Task RemoveAsync_Should_Delete()
    {
        ...
        // assert
        var deleted = db.GetCollection<FakeEntity>().Find(x => x.Id == 1);
